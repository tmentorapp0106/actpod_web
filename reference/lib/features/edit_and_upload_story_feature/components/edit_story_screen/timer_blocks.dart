...
class TimerBlocks extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    List<Widget> timerBlocks = [Container(width: ScreenUtil().screenWidth / 2,color: Colors.white,)];
    ...
    timerBlocks.add(Container(width: ScreenUtil().screenWidth / 2,color: Colors.white,));
