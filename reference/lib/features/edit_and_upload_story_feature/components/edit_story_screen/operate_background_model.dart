...
class OperateBackgroundModel extends ConsumerWidget {
  final int backgroundIndex;
  final EditTrimPlayController _playController;

  OperateBackgroundModel(this.backgroundIndex, this._playController);
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  GestureDetector(
                    onTap: () {
                      _playController.removeBackgroundMusic(backgroundIndex);
