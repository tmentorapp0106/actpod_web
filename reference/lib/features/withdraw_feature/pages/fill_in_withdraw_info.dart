...
class FillInWithdrawInfoPage extends ConsumerWidget {
  final int podcash;
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  ? () async {
                    ...
                    try {
                      await _withdrawController.createWithdraw(
                      ...
                      ToastService.showNoticeToast("提領申請失敗");
                      return;
                    }
                    ref.watch(loadingProvider.notifier).state = false;
                    ToastService.showSuccessToast("提領申請成功");
                    if(context.mounted) {
