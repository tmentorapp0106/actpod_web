...
class StoryBottomSheet extends ConsumerWidget {
  ...
  final GetStoriesByUserIdResItem story;
  final StoryController _storyController;
  final DownloadController _downloadController;

  StoryBottomSheet(this.story, this._storyController, this._downloadController);
  ...
  Widget removeStory(BuildContext context) {
    return InkWell(
      onTap: () async {
        await _storyController.archiveStory(story.storyId);
  ...
  Widget downloadStory(BuildContext context) {
    return InkWell(
      onTap: () async {
        await _downloadController.downloadAudioFile(story.storyUrl, story.storyName);
