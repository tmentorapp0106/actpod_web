  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Avatar(userInfo.userId, userInfo.avatarUrl, 28),
            const SizedBox(
              width: 8,
            ),
            Expanded(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return InkWell(
                            ...
                            onTap: () {
                              ...
                              ref
                                  .watch(selectedStickerDonateAmountProvider
                                      .notifier)
                                  .state = amount;
                            },
                            child: Container(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return InkWell(
                            ...
                            onTap: () {
                              ref
                                  .watch(selectedStickerProvider.notifier)
                                  .state = sticker.url;

                              ref
                                  .watch(selectedStickerDonateAmountProvider
                                      .notifier)
                                  .state = selectedDonateAmount;
