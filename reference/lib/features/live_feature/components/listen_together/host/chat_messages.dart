...
import 'package:quick_share_app/features/live_feature/components/create_bulletin_dialog.dart';
...
class _ChatInputBarState extends ConsumerState<_ChatInputBar> {
  ...
  Future<void> _showStickerBottomSheet(
    ...
    await showModalBottomSheet(
      ...
      builder: (context) {
        final donateOptions = [0, 30, 50, 100, 300, 500, 1000];
