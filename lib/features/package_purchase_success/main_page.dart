...
class PackagePurchaseSuccessPage extends ConsumerStatefulWidget {
  ...
  const PackagePurchaseSuccessPage({
    super.key,
    required this.packageId,
  });

  @override
  ConsumerState<PackagePurchaseSuccessPage> createState() =>
      _PackagePurchaseSuccessPageState();
}

class _PackagePurchaseSuccessPageState
    extends ConsumerState<PackagePurchaseSuccessPage> {
  late final PackagePurchaseSuccessController controller;

  @override
  void initState() {
    super.initState();
    controller = PackagePurchaseSuccessController(ref);
  ...
  @override
  void didUpdateWidget(covariant PackagePurchaseSuccessPage oldWidget) {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return _PackagePurchaseSuccessView(isDesktop: isDesktop);
      },
    );
  }
}

class _PackagePurchaseSuccessView extends ConsumerWidget {
  final bool isDesktop;

  const _PackagePurchaseSuccessView({
    required this.isDesktop,
  });

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final package = ref.watch(packagePurchaseSuccessProvider);
    final loading = ref.watch(packagePurchaseSuccessLoadingProvider);
    final error = ref.watch(packagePurchaseSuccessErrorProvider);
