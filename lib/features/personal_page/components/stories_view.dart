...
class StoriesView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
        ...
        child: storyList == null || storyList.isEmpty
            ? emptyView()
            : storiesView(ref, storyList, userInfoDto));
  }
  ...
  Widget storiesView(
      WidgetRef ref, List<StoryItem> storyList, UserInfoDto? otherUserInfo) {
  ...
  Widget storyWidget(
      BuildContext context, WidgetRef ref, StoryItem story, int index) {
    return InkWell(
        onTap: () {
                ...
                SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(children: [
                          ChannelImage(story.channelImageUrl, story.channelName,
                              18.w, 12.w),
                          SizedBox(
                            width: 2.w,
                          ),
                                ...
                                children: [
                                  ...
                                  Text(
                                    TimeUtils.formatDuration(
                                        Duration(
                                            milliseconds: story.totalLength),
                                        " HH:mm:ss"),
                                    style: TextStyle(
                                        fontSize: 12.w, color: Colors.black),
                                  ),
