...
class SearchUserBottomSheet {
  ...
  final CreateChannelController createChannelController;
  final FocusNode _focusNode = FocusNode();

  SearchUserBottomSheet(this.context, this.createChannelController);
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            onChanged: (nickname) {
                              createChannelController.searchUserList(nickname);
                            },
